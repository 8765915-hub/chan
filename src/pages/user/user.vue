<template>
  <view class="container">
    <view class="user-header card">
      <view class="info" v-if="userStore.isLoggedIn">
        <image :src="userStore.userInfo.avatarUrl" class="avatar" @click="changeAvatar"></image>
        <view class="text-info">
          <view class="nickname">{{ userStore.userInfo.nickName }}</view>
          <view class="id">ID: 888888</view>
        </view>
      </view>
      <view class="info" v-else>
        <view class="avatar placeholder"></view>
        <view class="text-info">
          <view class="nickname" @click="handleLogin">点击登录</view>
          <view class="desc">登录后开启铲屎之旅</view>
        </view>
      </view>
    </view>
